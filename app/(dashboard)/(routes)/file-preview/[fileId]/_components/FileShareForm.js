        ...
        <div className='flex flex-col gap-2'>
            ...
            {isPasswordEnable ?
                <div className='flex gap-3 items-center'>
                    ...
                    <button className='p-2 bg-primary text-white rounded-md disabled:bg-gray-300 hover:bg-blue-600' disabled={password?.length < 3} onClick={() => onPasswordSave(password)}>Save</button>
                </div> : null}
